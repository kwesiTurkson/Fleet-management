            ...
            <div class="col-md-6">
                <form class="animated bounce" action="bookingaction.php" method="post">
                    ...
                    <div class="input-group">
                      ...
                      <input id="name" type="text" class="form-control" name="name" placeholder="Enter your name" value="<?php echo $row['first_name']?>" required>
                    </div>
                    ...
                    <div class="input-group">
                      ...
                      <label><input type="radio" name="type" value="motor">Motor</label>
                    </div>
                    <br>
                    <div class="input-group">
                    ...
                    <!-- <div class="input-group">
                    <span class="input-group-addon"><b>KEK branch</b></span>
                    <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" required>
                       <option selected>Select KEK branch</option>
                        <option value="1">Airport Residential </option>
                        <option value="2">Awudome</option>
                        <option value="3">Tema</option>
                        <option value="4">Tamale</option>
                        <option value="5">Kumasi</option>
                        <option value="6">Tarkwa</option>
                    ...
                    <div class="input-group">
                      ...
                      <input id="email" type="email" class="form-control" name="email" placeholder="Provide your email here" required>
                    </div>
                    <br>
